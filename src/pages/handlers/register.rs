        ...
        <main class="flex justify-center w-full bg-slate-200 min-h-screen">
            <div class="mx-2 md:w-1/2 my-4 w-full self-start bg-white shadow-md">
                <form class="p-4">
                    ...
                    <p class="w-full text-start mb-4 flex gap-2">
                        <input
                            class="appearance-none w-4 h-4 peer relative border-2 transition-colors duration-75 border-gray-500 mt-1 rounded-sm shrink-0 bg-white checked:bg-red-500 checked:border-0"
                            type="checkbox"
                        />
                    ...
                    <button class="rounded-md hover:shadow-[0_2px_8px_0_rgba(0,0,0,0.5)] transition-all bg-[#ef4444] hover:bg-[#d83c3c] text-white p-2 w-full mb-5">
                        "Criar cadastro"
                    </button>
                </form>
            </div>
